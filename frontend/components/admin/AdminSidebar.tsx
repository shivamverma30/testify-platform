...
const navItems = [
  ...
  { href: "/admin/create-test", label: "Create Test", icon: PlusSquare },
  { href: "/admin/all-tests", label: "All Tests", icon: ClipboardList },
  { href: "/admin/test-series", label: "Test Series", icon: ScrollText },
    ...
    <aside className="sticky top-0 h-screen w-full border-r border-white/10 bg-slate-950/70 p-4 backdrop-blur-xl md:w-72 md:p-6">
      <div className="glass-card mb-8 flex items-center gap-3 rounded-2xl p-3">
        ...
        <div>
          ...
          <p className="font-display text-sm font-semibold text-slate-100">Coaching Admin Panel</p>
        </div>
      </div>
